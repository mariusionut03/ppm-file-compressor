...
/* This function get the path to a PPM file and return a matrix with it's pixels */
...
// Gets a pixel matrix and returns a quadtree build by the rules presented in README
...
// Helper function to print a quadtree level by level
...
// Read a quadtree level by level
